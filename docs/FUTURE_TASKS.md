...
- [ ] 🟡✓ **Look-Ahead** (2026-04-26 ProCamera2D 導入済み、着手可能)
  - **背景**: プレイヤー移動方向に先行してカメラを動かす機能
  - **仕様**: `ProCamera2DForwardFocus` を Camera にアタッチ、PlayerCharacter の velocity をターゲット情報として供給
  - **対象**: Camera Prefab / `PlayerCharacter`
