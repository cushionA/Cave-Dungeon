...
WAVE_PLAN.md の Wave 2（主要 hook 群）は当初 4 PR 構成。PR #46 / #47 / #48 / #49 で 2 系列が完了し、Phase 10 (PR `feature/wave2-phase10-two-layer`) と Phase 17 (PR `feature/wave2-phase17-handoff`) で Wave 2 を完遂する見込み。**実時間が必要なタスクのみ本セクションに残す。**
